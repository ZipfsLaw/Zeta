--ZetaTppPlayer2CallbackScript.lua
--Purpose: Vanilla TppPlayer2CallbackScript, but with function for mod access
this.callBackScript = {
...
ZetaIndex.ModFunction("TppPlayer2CallbackScript", this.callBackScript )
TppPlayer2CallbackScript = this.callBackScript