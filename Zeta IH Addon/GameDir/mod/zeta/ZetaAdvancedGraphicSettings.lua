...
function this.ModMenu()
  ...
  return{
    {
      var="FAQs",name="How To Apply In-Game",
      desc="-Press the PAUSE Button\n-Go to OPTIONS\n-Go to Graphic Settings\n-Choose OK and apply graphic settings.",
      command=function()end,
    },
    {
      var="QualitySettingPreset",name="Quality Preset",desc="Changes which custom quality preset to use.",
      presets={
    ...
    {
      var="DirectionalLightShadowResolution",name="Dir. Light Shadow Resolution",desc="Change shadow resolution of directional lighting.",
      list=this.shadowResRangeLabel,
      default=12,
      func=funcReload,
    },
    {
      var="SpotLightShadowResolution",name="Spotlight Shadow Resolution",desc="Change shadow resolution of spot lighting.",
      list=this.shadowResRangeLabel,
      default=11,
      func=funcReload,
    },
    {
      var="PointLightShadowResolution",name="Point Light Shadow Resolution",desc="Change shadow resolution of point lighting.",
      list=this.shadowResRangeLabel,
      default=12,
      func=funcReload,
    },
    {
      var="ShadowCascadeRange",name="Shadow Cascading Detail",
    ...
    {
      var="ShadowCastingStaticLightCount",name="Static Light Count",desc="Change the count of static shadow casting lights.",
      default=12,
      number={min=2, max=32, inc=1},
      func=funcReload,
    },
    {
      var="ShadowCastingDynamicLightCount",name="Dynamic Light Count",desc="Change the count of dynamic shadow casting lights.",
      default=4,
      number={min=2, max=32, inc=1},
      func=funcReload,
    },
    {
      var="ModelDrawDistance",name="Model Draw Distance",desc="Change the draw distance for models.",
      default=128,
      number={min=0, max=2048, inc=32},
      func=funcReload,
    },
    {
      var="CloneDrawDistance",name="Clone Draw Distance",desc="Change the draw distance for clones.",
      default=250, --ZIP: Evergreen/TheSleepWalker says 2560 was the stable max distance for this
      number={min=0, max=2560, inc=32},
      func=funcReload,
    },
    {
      var="EnableFXAA",name="FXAA Post Process",desc="Toggle the FXAA post process effect.",
      default=1,
      func=funcReload,
    },
    {
      var="ReduceMipmaps",name="Use Low Quality Textures",desc="Reduces quality of certain textures to reduce Vram usage.",
      default=0,
      func=funcReload,
    },
  }
