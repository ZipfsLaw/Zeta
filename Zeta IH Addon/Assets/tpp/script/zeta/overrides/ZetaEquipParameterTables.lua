...
function this.GetBlastParameterTable()
	local table={
	0,
...
function this.GetSupportWeaponParameterTable()
	local table={
	0,
...
function this.Reload(toggle)
	...
	this.BlastParameterTable = {}
	this.SupportWeaponParameterTable = {}
	this.BlastParameterTable = this.GetBlastParameterTable()
	this.SupportWeaponParameterTable = this.GetSupportWeaponParameterTable() 
	
	--Load mods
	if toggle==true then
		ZetaIndex.SafeFunc("EquipParameterTables", this ) --Passthrough
	end

	TppEquip.ReloadEquipParameterTables{BlastParameter=this.BlastParameterTable,SupportWeaponParameter=this.SupportWeaponParameterTable}
end
