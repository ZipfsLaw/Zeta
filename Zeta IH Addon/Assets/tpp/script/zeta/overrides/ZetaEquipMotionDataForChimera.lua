...
function this.Reload(toggle)
	...
	--Load vanilla table
	this.motionsTable = this.GetMotionsTable()
	this.posesTable = this.GetPosesTable()
	this.mtarsTable = this.GetMtarsTable()
	this.assignmentsTable = this.GetAssignmentsTable()
	
	--Check mods
	if toggle==true then
		ZetaIndex.SafeFunc("EquipMotionDataForChimera", this ) --Passthrough
	end
		
	TppEquip.ReloadEquipMotionData2{version=0,motions=this.motionsTable,poses=this.posesTable,mtars=this.mtarsTable,assignments=this.assignmentsTable}
end
